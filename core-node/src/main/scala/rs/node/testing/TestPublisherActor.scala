...
class TestPublisherActor(id: String) extends ServiceCell(id) with StringStreamPublisher with ListStreamPublisher with SetStreamPublisher with DictionaryMapStreamPublisher with ActorWithTicks {
  override val serviceKey: ServiceKey = "pub"
...
//    None
  ...
  override def componentId: String = "TestPublisherActor"
}