...
trait StageBuilder[I1,O1,I2,O2] {
  def buildStage(sessionId: String, componentId: String)(implicit serviceCfg: ServiceConfig, globalConfig: GlobalConfig, pub: WithSyseventPublisher): BidiFlow[I1,O1,I2,O2, Unit]
}
