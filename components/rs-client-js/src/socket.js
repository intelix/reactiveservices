...
import Sysappevents from "./appevents";
...
var endpoints = _.isUndefined(Config.endpoints) ? [] : Config.endpoints;

var endpointToTryIdx = 0;
var endpointFailureCount = 0;

var reconnectInterval = _.isUndefined(Config.reconnectInterval) ? 100 : Config.reconnectInterval;
var connectionEstablishTimeout = _.isUndefined(Config.connectionEstablishTimeout) ? 4000 : Config.connectionEstablishTimeout;
...
Sysappevents.signals.TerminateSession.add(_handleTerminate);
