...
class ShapingStage extends BytesStageBuilder {
  override def buildStage(sessionId: String, componentId: String)(implicit serviceCfg: ServiceConfig, nodeCfg: RootConfig): Option[BidiFlow[ByteString, ByteString, ByteString, ByteString, NotUsed]] =
